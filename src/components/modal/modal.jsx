        ...
        <div className="w-10/12 m-auto z-50 p-4">  
            ...
            <div className="p-5 ">
             ...
             <a href={modalDetails.link}
                target='blank' 
                className="justify-self-end text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    more
