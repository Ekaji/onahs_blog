        ...
        <div>
            <div id="about" className='
             mt-14 w-4/5 mx-auto md:flex mb-20' data-scroll-section >
                <div className='md:w-2/4'>
                    <h3 className='text-2xl md:text-2xl  ml-2 tracking-tight anton uppercase text-emerald-600' >who am i</h3>
            ...
            <div id='stack' className=' w-full mb-20' data-scroll-section>
                <div className='w-4/5 mx-auto'>
                    <h3 className='text-2xl anton uppercase text-emerald-600'>my stack</h3>
                    <div className='pt-4'>
                        {stacks.map((stack, i) => (
                        <div key={i} 
                             className='border rounded-3xl border-emerald-300 px-6 py-1 text-base md:text-lg 
